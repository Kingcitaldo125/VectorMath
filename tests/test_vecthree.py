...
def test_cross_pass_two():
    '''
    Random cross product calculations
    '''
    assert v3.cross([1234,5,90],[45,77,63]) == [-6615,-73692,94793]
    assert v3.cross([-5,70,7],[100,-90,555]) == [39480,3475,-6550]
